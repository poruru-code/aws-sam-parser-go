# Where: tools/schema-gen/extract_specs.py
# What: Fetch and extract CFN resource specs into extension JSON files.
# Why: Provide extended schema coverage beyond the base SAM schema.
import gzip
import json
import os
