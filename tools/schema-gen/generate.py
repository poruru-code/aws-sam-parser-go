# Where: tools/schema-gen/generate.py
# What: Merge SAM schema with CFN extensions and generate Go types.
...
# 出力先: schema/sam_generated.go
# ツールからルートに戻ってパスを解決
PROJECT_ROOT = os.path.abspath(os.path.join(BASE_DIR, "../../"))
OUTPUT_FILE = os.path.join(PROJECT_ROOT, "schema/sam_generated.go")
