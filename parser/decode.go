// Where: parser/decode.go
// What: YAML decoding with intrinsic tag normalization.
// Why: Convert SAM templates into generic Go maps for downstream processing.
package parser
...
// DecodeYAML parses YAML and normalizes intrinsic tags into canonical Fn:: maps.
